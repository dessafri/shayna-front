                ...
                <div class="product-thumbs">
                  <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                    <div
                      ...
                      :class="thumb[0]==gambar_default ? 'active':''"
                    >
                    ...
                    <div
                      ...
                      :class="thumb[1]==gambar_default ? 'active':''"
                    >
                    ...
                    <div
                      ...
                      :class="thumb[2]==gambar_default ? 'active':''"
                    >
                    ...
                    <div
                      ...
                      :class="thumb[3]==gambar_default ? 'active':''"
                    >
...
import RelatedProduct from "@/components/RelatedProductShayna.vue";
export default {
  name: "Home",
  components: {
    // HelloWorld
